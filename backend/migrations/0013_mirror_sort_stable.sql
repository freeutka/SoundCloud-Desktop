...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "user_likes_tracks_user_created_key_idx"
    ON "user_likes_tracks" ("user_id", "created_at" DESC, "sc_track_id" DESC);
DROP INDEX IF EXISTS "user_likes_tracks_user_created_idx";

CREATE INDEX CONCURRENTLY IF NOT EXISTS "user_likes_playlists_user_created_key_idx"
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "user_followings_user_created_key_idx"
    ON "user_followings" ("user_id", "created_at" DESC, "target_user_urn" DESC);
DROP INDEX IF EXISTS "user_followings_user_created_idx";

CREATE INDEX CONCURRENTLY IF NOT EXISTS "user_owned_playlists_user_created_key_idx"
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "user_owned_tracks_user_created_key_idx"
